...
@section('title', 'About us - AKAD - Creative Digital Agency')
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
					<div class="team_member">
						<img src="{{ asset('assets/img/team.jpg') }}" alt="team image">		
						...
						<ul class="slides">
							<li class="testimonials_single">
								<div class="author_pic">
									<img src="{{ asset('assets/img/face.jpg') }}" alt="testimonial image">
								</div>
								<p>
					...
					<div class="row">
						<div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp">
							<div class="clients_single">
								<a href="#">
									<img src="{{ asset('assets/img/client.jpg') }}" alt="client logo">
								</a>
							</div>
						</div>
